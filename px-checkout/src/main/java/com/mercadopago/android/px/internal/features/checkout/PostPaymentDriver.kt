...
internal class PostPaymentDriver(builder: Builder) {
    ...
    fun execute() {
        when {
            ...
            postPaymentDeepLink.isNotNullNorEmpty() -> action.navigateToPostPaymentScreen(postPaymentDeepLink)
    ...
    interface Action {
        ...
        fun navigateToPostPaymentScreen(postPaymentDeepLink: String)
    }
}
